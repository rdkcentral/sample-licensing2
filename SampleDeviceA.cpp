...
namespace SampleTestC {
    ...
    // NEW CODE ADDED IN THIS PR (Copy of the same function that triggered SampleDeviceB)
    void testAudioModuleSecondary() {
        std::shared_ptr<alexaClientSDK::defaultClient::DefaultClient> client2 = alexaClientSDK::defaultClient::DefaultClient::create(
            deviceInfo,
            customerDataManager,
            m_externalMusicProviderMediaPlayersMap,
            m_externalMusicProviderSpeakersMap,
